ALTER TABLE  `user_balance_log`
    ADD COLUMN `new_balance` decimal(10, 2) NOT NULL  DEFAULT '0.00' COMMENT '操作后的余额数据' AFTER `frozen_balance`,
ADD COLUMN `new_frozen_balance` decimal(10, 2) NOT NULL DEFAULT '0.00' COMMENT '操作后的冻结的余额' AFTER `new_balance`;
...
CREATE TABLE `statement_download` (
                                      ...
                                      `gmt_create` bigint DEFAULT NULL COMMENT '申请时间',
                                      `start_time` bigint DEFAULT NULL COMMENT '筛选开始时间',
                                      `end_time` bigint DEFAULT NULL COMMENT '筛选结束时间',
                                      `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
                                      PRIMARY KEY (`statement_download_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='对账单下载';
...
CREATE TABLE `vendor_product` (
                                  ...
                                  `product_brand_id` int DEFAULT NULL COMMENT '商品品牌ID',
                                  `product_category_id` int NOT NULL COMMENT '商品类目ID',
                                  `product_sn_generate_type` tinyint NOT NULL COMMENT '商品编码生成类型；1-系统生成，2-手动输入',
                                  `product_brief` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '商品描述',
                                  `product_state` tinyint NOT NULL COMMENT '商品状态；0-断供，1-在售',
                                  `sku_type` tinyint NOT NULL COMMENT '规格类型，1-单规格，2-多规格',
                                  `product_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '商品详情',
                                  `audit_state` tinyint NOT NULL COMMENT '商品审核状态；0-待审核，1-审核通过，2-审核失败',
                                  `pic_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '商品实际图片',
                                  `pic_thumb` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '商品缩略图片',
                                  `pic_original` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '商品原始图片',
                                  `is_recycle` tinyint DEFAULT '0' COMMENT '是否回收；0-否，1-是',
                                  `vendor_id` int NOT NULL COMMENT '供应商 ID',
                                  `create_time` bigint NOT NULL COMMENT '创建时间',
                                  `create_by_id` bigint DEFAULT '0' COMMENT '创建人主键',
                                  `create_by_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
                                  `update_time` bigint NOT NULL COMMENT '更新时间',
                                  `update_by_id` bigint DEFAULT '0' COMMENT '编辑人主键',
                                  `update_by_name` bigint DEFAULT NULL COMMENT '更新人名称',
                                  `is_del` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除；0-否，1-是',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='供应商商品';

CREATE TABLE `vendor_product_audit_log` (
                                            `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
                                            `vendor_product_id` bigint DEFAULT NULL COMMENT '供应商商品 ID',
                                            `audit_state` tinyint DEFAULT NULL COMMENT '审核状态；0-待审核，1-审核通过，2-审核失败',
                                            `audit_fail_reason` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审核失败原因',
                                            `vendor_id` int NOT NULL COMMENT '供应商 ID',
                                            `create_time` bigint NOT NULL COMMENT '创建时间',
                                            `create_by_id` bigint DEFAULT '0' COMMENT '创建人主键',
                                            `create_by_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
                                            `update_time` bigint NOT NULL COMMENT '更新时间',
                                            `update_by_id` bigint DEFAULT '0' COMMENT '编辑人主键',
                                            `update_by_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更新人名称',
                                            `is_del` tinyint NOT NULL COMMENT '是否删除；0-否，1-是',
                                            PRIMARY KEY (`id`),
                                            KEY `vendor_product_audit_log_vendor_product_id_index` (`vendor_product_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='供应商商品审核记录';

CREATE TABLE `vendor_product_gallery` (
                                          `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
                                          `vendor_product_id` int NOT NULL COMMENT '供应商商品 ID',
                                          `pic_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '实际图片url',
                                          `pic_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '图片说明信息',
                                          `pic_thumb` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '微缩图片url',
                                          `pic_original` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '原图url',
                                          `pic_large` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '高清图片url',
                                          ...
                                          PRIMARY KEY (`id`),
                                          KEY `vendor_product_gallery_vendor_product_id_index` (`vendor_product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='供应商商品相册';


CREATE TABLE `vendor_product_sku` (
                                      `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
                                      `vendor_product_id` int NOT NULL COMMENT '供应商商品 ID',
                                      `sku_attr_val` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '商品规格值（拼接',
                                      `sku_attr_json` json DEFAULT NULL COMMENT '商品规格值（json）',
                                      `sku_sn` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '规格编码',
                                      `sku_tsn` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '规格条形码',
                                      `sku_weight` int DEFAULT NULL COMMENT '规格重量',
                                      `sku_stock` int DEFAULT NULL COMMENT '规格库存',
                                      ...
                                      `sales_volume` int DEFAULT '0' COMMENT '规格销量',
                                      `vendor_id` int NOT NULL COMMENT '供应商 ID',
                                      `create_time` bigint NOT NULL COMMENT '创建时间',
                                      `create_by_id` bigint DEFAULT '0' COMMENT '创建人主键',
                                      `create_by_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
                                      ...
                                      `is_del` tinyint DEFAULT '0' COMMENT '是否删除；0-否，1-是',
                                      PRIMARY KEY (`id`),
                                      KEY `vendor_product_sku_vendor_product_id_index` (`vendor_product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='供货商商品规格';

CREATE TABLE `vendor_product_sku_attr` (
                                           `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID ',
                                           `vendor_product_id` int NOT NULL COMMENT '供应商商品 ID ',
                                           `attr_type` tinyint NOT NULL COMMENT '属性类型，0-普通属性，1-规格属性，2-附加规格',
                                           `attr_name` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '属性所属类型的名称',
                                           `attr_value` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '具体属性的值 ',
                                           `attr_price` decimal(10,2) DEFAULT NULL COMMENT '属性价格',
                                           `attr_color` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '属性颜色',
                                           `attr_pic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '属性图片',
                                           `attr_pic_thumb` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '属性缩略图',
                                           `vendor_id` int NOT NULL COMMENT '供应商 ID',
                                           `create_time` bigint NOT NULL COMMENT '创建时间',
                                           `create_by_id` bigint DEFAULT NULL COMMENT '创建人主键',
                                           `create_by_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
                                           `update_time` bigint NOT NULL COMMENT '更新时间',
                                           `update_by_id` bigint DEFAULT NULL COMMENT '编辑人主键',
                                           `update_by_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更新人名称',
                                           `is_del` tinyint DEFAULT '0' COMMENT '是否删除；0-否，1-是',
                                           PRIMARY KEY (`id`),
                                           KEY `vendor_product_sku_attr_vendor_product_id_index` (`vendor_product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='供应商商品规格属性';
...
CREATE TABLE `vendor_product_sku_stock_log` (
                                                ...
                                                `biz_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '业务备注',
                                                `vendor_id` int NOT NULL COMMENT '供应商 ID',
                                                `create_time` bigint NOT NULL COMMENT '创建时间',
                                                `create_by_id` bigint DEFAULT '0' COMMENT '创建人主键',
                                                `create_by_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
                                                ...
                                                `is_del` tinyint DEFAULT '0' COMMENT '是否删除；0-否，1-是',
                                                PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='供货商商品规格库存日志';
...
CREATE TABLE `vendor_product_video` (
                                        ...
                                        `format` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '视频格式后缀',
                                        `vendor_id` int NOT NULL COMMENT '供应商 ID',
                                        `create_time` bigint NOT NULL COMMENT '创建时间',
                                        `create_by_id` bigint DEFAULT '0' COMMENT '创建人主键',
                                        `create_by_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
                                        ...
                                        `is_del` tinyint DEFAULT '0' COMMENT '是否删除；0-否，1-是',
                                        PRIMARY KEY (`id`),
                                        KEY `vendor_product_video_vendor_product_id_index` (`vendor_product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='供应商商品视频';
...
INSERT INTO `authority` (`authority_id`, `authority_sn`, `authority_name`, `parent_id`, `sort_order`, `is_show`, `child_auth`, `route_link`, `authority_ico`, `is_system`, `admin_type`)
VALUES
    (11001058, 'organize', '组织', 0, 50, 1, '[]', '', 'iconfont-tig icon-guanliyuan', 0, 'admin');
...
UPDATE `authority`
SET `authority_sn` = 'adminMerchant',
    `authority_name` = '商户管理',
    `parent_id` = 11001058,
    `sort_order` = 54,
    `is_show` = 1,
    `child_auth` = '[]',
    `route_link` = 'adminMerchant/apply/list/',
    `authority_ico` = 'iconfont-tig icon-31quanbushangpin',
    `is_system` = 0,
    `admin_type` = 'admin'
WHERE
    `authority_id` = 276;
UPDATE `authority`
SET `authority_sn` = 'shopManagement',
    `authority_name` = '店铺管理',
    `parent_id` = 11001058,
    `sort_order` = 50,
    `is_show` = 1,
    `child_auth` = '[]',
    `route_link` = '',
    `authority_ico` = 'iconfont-tig icon-dianpuguanli',
    `is_system` = 0,
    `admin_type` = 'admin'
WHERE
    `authority_id` = 10000416;
UPDATE `authority`
SET `authority_sn` = 'vendorManage',
    `authority_name` = '供应商管理',
    `parent_id` = 11001058,
    `sort_order` = 50,
    `is_show` = 1,
    `child_auth` = '[]',
    `route_link` = '',
    `authority_ico` = 'iconfont-tig icon-gongying',
    `is_system` = 0,
    `admin_type` = 'admin'
WHERE
    `authority_id` = 11001001;
...
ALTER TABLE `admin_role` MODIFY COLUMN `admin_type` varchar(255) DEFAULT 'admin' COMMENT 'admin（平台）/ shop（店铺）/ vendor（供应商）';
ALTER TABLE `admin_role` ADD COLUMN `vendor_id` int(11) NOT NULL DEFAULT '0' COMMENT '供应商ID',
