...
export const formatCommonStyle = (moduleStyle, moduleContentStyle, moduleSubTitle) => {
    const obj = {
        moduleStyle: {},
        moduleContentStyle: {},
        moduleSubTitle: {}
    ...
    if (moduleContentStyle) {
        obj.moduleContentStyle = {
            ...
            backgroundImage: moduleContentStyle.backgroundPic?.picUrl
                ...
                : `background-image: linear-gradient( ${gradientMap[moduleContentStyle.gradientType]}, ${moduleContentStyle.gradientColorA}, ${moduleContentStyle.gradientColorB});`,
...
export const formatAnimation = (type, range) => {
...
export const copyArray = (data, num = 1) => {
    let result = [];
    for (let i = 0; i < num; i++) {
