...
class KDNiaoService extends LogisticsService
{
     ...
     * @var string
     */
    protected string $traceUrl = 'https://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx';
    /**
     * 电子面单接口地址
     * @var string
     */
    ...
    public function getElectronicWaybill(array $order, string $remark = ''): array
    {
        ...
        // 寄件人信息
        $sender_data = [
            'ProvinceName' => $this->config['province_name'],
            'CityName' => $this->config['city_name'],
            'ExpAreaName' => $this->config['area_name'],
