...
export class PointsExchangeController {
  ...
  async updatePointsExchange(@Body() updateDto: UpdatePointsExchangeDto) {
    const result = await this.pointsExchangeService.update(updateDto.id, updateDto);
  ...
  @ApiResponse({ status: 200, description: '更新成功' })
  async updatePointsExchangeField(@Body() updateDto: UpdatePointsExchangeFieldDto) {
    const result = await this.pointsExchangeService.updateField(updateDto.id, updateDto.field, updateDto.value);
  ...
  @ApiResponse({ status: 200, description: '删除成功' })
  async batchDeletePointsExchange(@Body() batchDto: BatchDeletePointsExchangeDto) {
