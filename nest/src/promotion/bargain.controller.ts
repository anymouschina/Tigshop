...
export class BargainController {
  ...
  async updateBargain(@Body() updateDto: UpdateBargainDto) {
    const result = await this.bargainService.update(updateDto.bargain_id, updateDto);
  ...
  async updateBargainField(@Body() updateDto: UpdateBargainFieldDto) {
    const result = await this.bargainService.updateField(updateDto.id, updateDto.field, updateDto.value);
