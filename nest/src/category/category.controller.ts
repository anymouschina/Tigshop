...
export class CategoryController {
  ...
  async getRelateCategory(@Query() query: {
    product_id?: number;
    size?: number;
    rank_num?: number;
    intro?: string;
  ...
  async getRelateBrand(@Query() query: {
    product_id?: number;
    size?: number;
    rank_num?: number;
    intro?: string;
  ...
  async getRelateArticle(@Query() query: {
    product_id?: number;
    size?: number;
    rank_num?: number;
    intro?: string;
  ...
  async getRelateRank(@Query() query: {
    product_id?: number;
    size?: number;
    rank_num?: number;
    intro?: string;
  ...
  async getRelateLookAlso(@Query() query: {
    product_id?: number;
    size?: number;
    rank_num?: number;
    intro?: string;
