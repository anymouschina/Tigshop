...
export class ConfigService {
  ...
  async initConfigSettings(): Promise<void> {
    const defaultConfigs = [
      ...
      {
        biz_code: "shopTitle",
        biz_val: "Tigshop商城 - 您的购物首选",
        comment: "商店标题",
      },
      {
        biz_code: "shopTitleSuffix",
        biz_val: "- Tigshop商城",
        comment: "商店标题后缀",
      },
      {
        biz_code: "shopLogo",
        biz_val: "/uploads/logo.png",
        comment: "商店Logo",
      },
      {
        biz_code: "shopKeywords",
        biz_val: "商城,购物,电商",
        comment: "商店关键词",
      },
      {
        biz_code: "shopDesc",
        biz_val: "专业的电商平台，为您提供优质的购物体验",
        comment: "商店描述",
      },
      ...
      // 微信设置
      {
        biz_code: "openWechatOauth",
        biz_val: "1",
        comment: "开启微信OAuth登录",
      },
      { biz_code: "openWechatRegister", biz_val: "1", comment: "开启微信注册" },
      {
        biz_code: "wechatRegisterBindPhone",
        biz_val: "1",
        comment: "微信注册绑定手机号",
      },
      ...
      {
        biz_code: "facebookLoginOn",
        biz_val: "1",
        comment: "开启Facebook登录",
      },
      ...
      {
        biz_code: "shopIcpNoUrl",
        biz_val: "https://beian.miit.gov.cn",
        comment: "ICP备案查询链接",
      },
      { biz_code: "shop110No", biz_val: "", comment: "公安备案号" },
      {
        biz_code: "shop110Link",
        biz_val: "https://beian.mps.gov.cn/#/query/webSearch",
        comment: "公安备案查询链接",
      },
      {
        biz_code: "shopCompany",
        biz_val: "江西佰商科技有限公司",
        comment: "公司名称",
      },
      {
        biz_code: "companyAddress",
        biz_val: "江西省南昌市",
        comment: "公司地址",
      },
      ...
      {
        biz_code: "poweredBy",
        biz_val: "Powered by Tigshop",
        comment: "版权信息",
      },
      {
        biz_code: "poweredByLogo",
        biz_val: "/uploads/powered-by.png",
        comment: "版权Logo",
      },
      {
        biz_code: "defaultTechSupport",
        biz_val: "Tigshop技术支持",
        comment: "默认技术支持",
      },
      ...
      // 分类装饰设置
      {
        biz_code: "productCategoryDecorateType",
        biz_val: "1",
        comment: "商品分类装饰类型",
      },
      {
        biz_code: "defaultHeaderStyle",
        biz_val: "modern",
        comment: "默认头部样式",
      },
      {
        biz_code: "lightShopLogo",
        biz_val: "/uploads/light-logo.png",
        comment: "浅色主题Logo",
      },
      ...
      // 默认设置
      {
        biz_code: "defaultShopName",
        biz_val: "默认店铺",
        comment: "默认店铺名称",
      },
      {
        biz_code: "isOpenMobileAreaCode",
        biz_val: "1",
        comment: "是否开启手机区号",
      },
      ...
      // 用户等级设置
      {
        biz_code: "growUpSetting",
        biz_val: JSON.stringify({
      ...
      // 装饰页面配置
      {
        biz_code: "decoratePageConfig",
        biz_val: JSON.stringify({
          pcIndex: {
            style: "modern",
            modules: ["banner", "category", "product"],
          },
          mobileIndex: {
            style: "simple",
            modules: ["search", "banner", "product"],
          },
        }),
        comment: "装饰页面配置",
      },
