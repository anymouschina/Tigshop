...
export enum FriendLinksStatus {
  DISABLED = 0, // 禁用
  ENABLED = 1, // 启用
}

export class FriendLinksQueryDto {
  ...
  @ApiProperty({ description: '状态', required: false, enum: FriendLinksStatus })
  @IsOptional()
  @IsEnum(FriendLinksStatus)
  status?: FriendLinksStatus;

  @ApiProperty({ description: '排序字段', required: false, default: 'link_id' })
  @IsOptional()
  @IsString()
  sortField?: string = 'link_id';
...
export class CreateFriendLinksDto {
...
export class UpdateFriendLinksDto {
...
export class FriendLinksConfigDto {
