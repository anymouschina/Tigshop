...
import { IsEnum, IsOptional, IsString, IsNumber, IsBoolean, IsArray, IsNotEmpty } from 'class-validator';
...
export class CreateNotificationDto {
  ...
  @ApiProperty({ description: '通知渠道', enum: NotificationChannel, isArray: true })
  @IsArray()
