...
import {
  UpdateOrderConfigDto,
  OrderPaymentConfigDto,
  OrderShippingConfigDto,
...
export class OrderConfigController {
  ...
  async updatePaymentConfig(@Body() paymentConfig: OrderPaymentConfigDto) {
    const result =
      await this.orderConfigService.updatePaymentConfig(paymentConfig);
    return {
      code: 200,
      message: "更新成功",
      data: result,
  ...
  async updateShippingConfig(@Body() shippingConfig: OrderShippingConfigDto) {
    const result =
      await this.orderConfigService.updateShippingConfig(shippingConfig);
    return {
      code: 200,
      message: "更新成功",
      data: result,
