...
export class AdminController {
  ...
  async assignRolesToUser(
    ...
    return this.adminService.assignRolesToUser(parseInt(adminId), assignRolesDto.roleIds);
  }
  ...
  async getSystemLogs(
    ...
    return this.adminService.getSystemLogs({ page, size, level, startDate, endDate });
  }
