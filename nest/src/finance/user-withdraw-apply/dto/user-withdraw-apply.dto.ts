...
import { IsOptional, IsNumber, IsString, IsEnum, IsNotEmpty, Min, ValidateNested } from 'class-validator';
...
export class CreateUserWithdrawApplyDto {
  ...
  @ApiProperty({ description: '状态', enum: WithdrawStatus, default: WithdrawStatus.PENDING })
  @IsOptional()
  @IsEnum(WithdrawStatus)
