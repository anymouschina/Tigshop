...
export class AccountPanelController {
  ...
  @ApiQuery({ name: 'search_start_date', description: '开始日期', required: false })
  @ApiQuery({ name: 'search_end_date', description: '结束日期', required: false })
  @Get('list')
  ...
  @ApiQuery({ name: 'period', description: '周期(day/week/month)', default: 'day' })
  @Get('trend')
