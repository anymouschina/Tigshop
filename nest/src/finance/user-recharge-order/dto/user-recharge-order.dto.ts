...
export class UserRechargeOrderQueryDto {
  ...
  @ApiProperty({ description: '状态', required: false, enum: RechargeOrderStatus })
  @IsOptional()
  ...
  @ApiProperty({ description: '排序字段', required: false, default: 'order_id' })
  @IsOptional()
  @IsString()
...
export class CreateUserRechargeOrderDto {
  ...
  @ApiProperty({ description: '状态', enum: RechargeOrderStatus, default: RechargeOrderStatus.PENDING })
  @IsOptional()
  @IsEnum(RechargeOrderStatus)
