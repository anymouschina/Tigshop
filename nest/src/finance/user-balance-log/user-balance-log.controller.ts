...
export class UserBalanceLogController {
  ...
  async batchRemove(@Body() batchDeleteUserBalanceLogDto: BatchDeleteUserBalanceLogDto) {
    return await this.userBalanceLogService.batchRemove(batchDeleteUserBalanceLogDto.ids);
  }
  ...
  async getMonthlyBalanceStats(
    ...
    return await this.userBalanceLogService.getMonthlyBalanceStats(userId, year);
  }
