...
export class CollectController {
  ...
  async getCollectList(
    @Request() req,
    @Query() collectListDto: CollectListDto,
  ...
  async collectProduct(
    @Request() req,
    @Body() collectProductDto: CollectProductDto,
  ): Promise<SuccessResponse> {
    return this.collectService.collectProduct(
      req.user.userId,
      collectProductDto,
    );
  }
  ...
  async cancelCollect(
    @Request() req,
    @Body() deleteCollectDto: DeleteCollectDto,
  ): Promise<SuccessResponse> {
  ...
  async batchDeleteCollect(
    @Request() req,
    @Body() batchDeleteCollectDto: BatchDeleteCollectDto,
  ): Promise<SuccessResponse> {
    return this.collectService.batchDeleteCollect(
      req.user.userId,
      batchDeleteCollectDto,
    );
  }
  ...
  async checkCollect(
    @Request() req,
    @Query() checkCollectDto: CheckCollectDto,
  ...
  async getCollectCount(
    @Request() req,
    @Query("collect_type") collect_type?: string,
  ): Promise<{ count: number }> {
    const count = await this.collectService.getCollectCount(
      req.user.userId,
      collect_type as any,
    );
    return { count };
  ...
  async getProductCollects(
    ...
    return this.collectService.getCollectList(
      req.user.userId,
      productCollectList,
    );
  }
